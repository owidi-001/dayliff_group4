...
class _$LoginDataImpl implements _LoginData {
  _$LoginDataImpl(
      {@JsonKey(name: "email") required this.email, required this.password});
...
class _$AuthTokenImpl implements _AuthToken {
  ...
  @override
  String toString() {
    return 'AuthToken(accessToken: $accessToken, message: $message)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, accessToken, message);
...
abstract class _AuthToken implements AuthToken {
  factory _AuthToken(
      ...
      @JsonKey(name: "message") final String? message}) = _$AuthTokenImpl;
...
class _$LoginResponseImpl implements _LoginResponse {
  _$LoginResponseImpl({required this.token, required this.user});
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, phoneNumber: $phoneNumber, email: $email, type: $type)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, phoneNumber, email, type);
