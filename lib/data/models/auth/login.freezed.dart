...
class _$LoginDataImpl implements _LoginData {
  _$LoginDataImpl({required this.phone, required this.password});
  ...
  @override
  String toString() {
    return 'LoginData(phone: $phone, password: $password)';
  }
...
class _$AuthTokenImpl implements _AuthToken {
  _$AuthTokenImpl({required this.accessToken});
...
abstract class _AuthToken implements AuthToken {
  factory _AuthToken({required final String accessToken}) = _$AuthTokenImpl;
