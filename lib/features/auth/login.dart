...
class _LoginFormState extends State<LoginForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        decoration: BoxDecoration(color: StaticColors.dark),
        child: Center(
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(color: StaticColors.onPrimary),
                      hintStyle: TextStyle(color: StaticColors.onPrimary),
                      border: OutlineInputBorder(
                        borderRadius:
                            const BorderRadius.all(Radius.circular(8)),
                        borderSide: BorderSide(color: StaticColors.onPrimary),
                      ),
